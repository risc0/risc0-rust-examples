pub mod words {
    ...
    pub static WORDS: [&str; 775] = [
        ...
        "cross", "crowd", "crown", "crude", "cruel", "crumb", "crush", "crust", "cubic", "curio",
        "curly", "curse", "cycle", "daily", "cairy", "daunt", "death", "debit", "decay", "defer",
        ...
        "ethic", "ethos", "event", "every", "evoke", "exact", "exalt", "excel", "exert", "exile",
        ...
        "sober", "solar", "solid", "solve", "sorry", "sound", "space", "spare", "speak", "speck",
